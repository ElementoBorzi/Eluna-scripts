...
if not PlayerInventory.showMailItemDialog then
    PlayerInventory.showMailItemDialog = function(itemData)
        -- Use the state machine for coordinated mail dialog opening
        ...
        if StateMachine and StateMachine.canOpenModal() then
            ...
            -- Open mail dialog through state machine with the item pre-attached
            StateMachine.openMailDialog(PlayerInventory.currentPlayerName, itemToMail)
