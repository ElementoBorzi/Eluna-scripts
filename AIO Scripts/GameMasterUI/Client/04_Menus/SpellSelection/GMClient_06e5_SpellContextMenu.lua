        ...
        },
        {
            ...
            menuList = {
                ...
                { isSeparator = true },
                {
                    ...
                    func = function()
                        if SpellSelection.AuraOptions and SpellSelection.AuraOptions.showAuraOptionsDialog then
                            SpellSelection.AuraOptions.showAuraOptionsDialog(spellData)
                        else
                            print("[ERROR] AuraOptions module not loaded")
                        end
                    end,
                    notCheckable = true,
                    tooltipTitle = "Advanced Options",
                    tooltipText = "Configure duration, stack count, and other aura options",
                },
                { isSeparator = true },
                {
