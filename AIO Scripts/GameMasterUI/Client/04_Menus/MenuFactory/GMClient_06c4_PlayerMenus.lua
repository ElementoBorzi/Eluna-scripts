...
function PlayerMenus.createPlayerMenu(entity)
    ...
    table.insert(menuItems, {
        text = "Send Mail",
        func = function()
            -- Open mail composition dialog through state machine
            local StateMachine = _G.GMStateMachine
            if StateMachine and StateMachine.canOpenModal() then
                StateMachine.openMailDialog(playerName)
            end
        end,
        notCheckable = true,
...
function PlayerMenus.addOnlineActions(menuItems, playerName, entity)
    ...
    table.insert(menuItems, {
        text = "Give Item",
        func = function()
            -- Open item selection modal through ItemSelection module
            if GMMenus and GMMenus.ItemSelection and GMMenus.ItemSelection.openModal then
                GMMenus.ItemSelection.openModal(playerName)
            end
        end,
        notCheckable = true,
    })
        ...
        menuList = {
            {
                ...
                func = function()
                    if GMMenus and GMMenus.SpellSelection and GMMenus.SpellSelection.openModal then
                        GMMenus.SpellSelection.openModal(playerName, "self")
                    end
                end,
                notCheckable = true,
            ...
            },
            {
                ...
                func = function()
                    if GMMenus and GMMenus.SpellSelection and GMMenus.SpellSelection.openModal then
                        GMMenus.SpellSelection.openModal(playerName, "target")
                    end
                end,
                notCheckable = true,
            ...
            },
            {
                ...
                func = function()
                    if GMMenus and GMMenus.SpellSelection and GMMenus.SpellSelection.openModal then
                        GMMenus.SpellSelection.openModal(playerName, "onplayer")
                    end
                end,
                notCheckable = true,
